...
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <link rel="icon" type="image/png" href="cpu.png">
...
@keyframes appear {
  ...
  100% {
   ...
   <div class="flex">
      ...
      <a style="margin-right:40px !important;text-decoration:none;" href="cart.php" class="cart">cart <span><?php echo $row_count; ?></span> </a>
      ...
      <a href="login.php" style="animation-delay: 0.1s;text-decoration:none;">Admin</a>
      <a href="index.php" style="animation-delay: 0.4s;text-decoration:none;">Products</a>
        </nav>
